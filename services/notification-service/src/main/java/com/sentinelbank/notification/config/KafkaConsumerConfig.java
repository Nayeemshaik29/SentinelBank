...
/** Same two-tier retry/DLT wiring as every other consumer in this project — see fraud-service's
 * identically-named class for the full rationale: a few fast retries on the main topic, then the
 * {@code .retry} topic, then {@code .dlt}. */
@Configuration
@EnableKafka
