...
/** Same two-tier retry/DLT wiring as fraud-service's identically-named class — see its javadoc for the full
 * rationale: a few fast retries on the main topic, then the {@code .retry} topic, then {@code .dlt}. */
@Configuration
@EnableKafka
